 ...
 * Customized by cgardner - do not overwrite */
    ...
    var t = !1,
        ...
        o = {
            ...
            addPrefix: function (e) {
                var t = e.attr("id"),
                    i = e.attr("class");
                "string" == typeof t && "" !== t && e.attr("id", t.replace(/([A-Za-z0-9_.\-]+)/g, "mobile-id-$1")), "string" == typeof i && "" !== i && "sidr-inner" !== i && e.attr("class", i.replace(/([A-Za-z0-9_.\-]+)/g, "mobile-$1")), e.removeAttr("style")
            },
...
//                e.preventDefault(), t.parent().toggleClass("sidr-highlight"), r.toogle(n)
